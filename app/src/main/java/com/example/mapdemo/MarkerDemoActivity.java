...
public class MarkerDemoActivity extends AppCompatActivity implements
    ...
    private static final LatLng BRISBANE = new LatLng(-8.138212391410718, -79.05059745199532);

    private static final LatLng MELBOURNE = new LatLng(-8.139474168997586, -79.04588845544116);

    private static final LatLng DARWIN = new LatLng(-8.132801480725533, -79.03816253457295);

    private static final LatLng SYDNEY = new LatLng(-8.138366474880025, -79.03331175684269);

    private static final LatLng ADELAIDE = new LatLng(-8.139387814173128, -79.0426901125165);

    private static final LatLng PERTH = new LatLng(-8.142561628669089, -79.04480352960742);
    ...
    class CustomInfoWindowAdapter implements InfoWindowAdapter {
        ...
        private void render(Marker marker, View view) {
            ...
            if (marker.equals(mBrisbane)) {
                badge = R.drawable.av_larco12345678;
            } else if (marker.equals(mAdelaide)) {
                badge = R.drawable.los_laureles12345678;
            } else if (marker.equals(mSydney)) {
                badge = R.drawable.av_el_golf12345678;
            } else if (marker.equals(mMelbourne)) {
                badge = R.drawable.manuel_seoane12345678;
            } else if (marker.equals(mPerth)) {
                badge = R.drawable.c_1812345678;
            } else if (marker.equals(mDarwin1)) {
                badge = R.drawable.av_los_angeles12345678;
    ...
    public void onMapReady(GoogleMap map) {
        ...
        CameraPosition googlePlex = CameraPosition.builder()
                .target(new LatLng(BRISBANE.latitude, BRISBANE.longitude))
